...
class ApiClient {
  ApiClient({this.basePath = 'https://app.insertname.com/api'}) {
    // Setup authentications (key: authentication name, value: authentication).
    _authentications['ApiKeyAuth'] = HttpBearerAuth();
  }
    ...
    try {
      switch (targetType) {
        ...
        case 'AnswerToQuestion':
          return AnswerToQuestion.fromJson(value);
        case 'GenericTest':
          return GenericTest.fromJson(value);
        case 'GenericTestAnswers':
          return GenericTestAnswers.fromJson(value);
        case 'GenericTestQuestions':
          return GenericTestQuestions.fromJson(value);
        case 'GetAccountIdResponse':
          return GetAccountIdResponse.fromJson(value);
        case 'JWTAccountDetails':
          return JWTAccountDetails.fromJson(value);
        case 'LoginAccount':
          return LoginAccount.fromJson(value);
        case 'LogoutAccount':
          return LogoutAccount.fromJson(value);
        case 'Project':
          return Project.fromJson(value);
        case 'ProjectsAccountId':
          return ProjectsAccountId.fromJson(value);
        case 'RefreshDetails':
          return RefreshDetails.fromJson(value);
        case 'SignUp':
          return SignUp.fromJson(value);
        case 'Test':
          return Test.fromJson(value);
        case 'TestsProject':
          return TestsProject.fromJson(value);
        default:
          Match match;
